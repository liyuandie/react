    ...
    render() {
        return (
            <TodoFooter>
                ...
                <Filter>
                    <FilterLi>
                        <FilterBtn onClick={this.all} checked={this.state.isOnClick === 'all'}>All</FilterBtn>
                        <FilterBtn onClick={this.active} checked={this.state.isOnClick === 'active'}>Active</FilterBtn>
                        <FilterBtn onClick={this.completed} checked={this.state.isOnClick === 'completed'}>Completed</FilterBtn>
                    </FilterLi>
                </Filter>
